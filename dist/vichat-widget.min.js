...
function loadGuestHistory(config = DEFAULT_CONSTANTS, agentId) {
...
function saveGuestHistory(arr, config = DEFAULT_CONSTANTS, agentId) {
  writeLocalStorage(resolveHistoryKey(config, agentId), JSON.stringify(arr || []));
}

function clearGuestHistory(config = DEFAULT_CONSTANTS, agentId) {
...
'src/core/agents.js': (module, exports, __require) => {
...
exports.normalizeAgents = normalizeAgents;
...
'src/core/ui/agentHub.js': (module, exports, __require) => {
...
function createAgentHubController({ hubEl, listEl, emptyEl, onSelect }) {
...
exports.createAgentHubController = createAgentHubController;

},
'src/core/ui/sidebar.js': (module, exports, __require) => {
...
function createSidebarController({ listEl, onSelect }) {
...
exports.createSidebarController = createSidebarController;
...
exports.ensureMarkdownLibs = ensureMarkdownLibs;
...
async function fetchMe({ token, config }) {
...
async function fetchMessages({ token, config, agentId }) {
...
async function clearMessages({ token, config, agentId }) {
...
async function importGuestMessages({ token, guestHistory, config, agentId }) {
...
async function askValki({ message, clientId, images, token, config, agentId }) {
...
const { DEFAULT_AGENTS, findAgentById, normalizeAgents } = __require('src/core/agents.js');
...
const { createAgentHubController } = __require('src/core/ui/agentHub.js');
const { createSidebarController } = __require('src/core/ui/sidebar.js');
